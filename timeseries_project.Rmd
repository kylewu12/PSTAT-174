...
From the decomposition, we can get a general idea of the trend and seasonality present within the plot, which will then allow us to better estimate and thus forecast the data moving forwards.
...
regmodel = lm(total_vehicles$TOTALNSA ~ trend + trend2)

summary(regmodel)

acf2(resid(regmodel))

adjreg = sarima(total_vehicles$TOTALNSA, 0,0,12, xreg = cbind(trend, trend2))
